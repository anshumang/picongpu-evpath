/**
 * Copyright 2015 Anshuman Goswami
 *
...
#include "traits/PICToEVPath.hpp"
...
/** write attribute of a particle to evpath transport
 *
...
struct ParticleAttribute
{
    ...
    /** write attribute to evpath transport
     *
                            ...
                            const size_t elements)
    {
        ...
        log<picLog::INPUT_OUTPUT > ("EVPath:  (begin) write species attribute: %1%") % Identifier::getName();
        ...
        log<picLog::INPUT_OUTPUT > ("EVPath:  ( end ) write species attribute: %1%") %
            Identifier::getName();
    }
